export const Projects = () => (
  <section>
    <p className="my-2">My little fun projects</p>

    <ul className="ml-8 ">
      <li>
        <a
          href="https://artialex.github.io/about/"
          target="_blank"
          rel="noreferef noopener"
        >
          My "About me" page
        </a>{' '}
        <span className="text-sm text-zinc-500">(this page)</span>
      </li>
      <li>
        <a
          href="https://artialex.github.io"
          target="_blank"
          rel="noreferef noopener"
        >
          My personal digital garden / stash of notes
        </a>
      </li>
    </ul>

    <p className="my-2">I'm on the internet</p>
    <ul className="ml-8 flex gap-4">
      ...
      <li>
        <a
          ...
          rel="noreferer noopener"
        >
          <svg className="w-6" viewBox="0 0 128 128">
            <path
              fill="#0076b2"
